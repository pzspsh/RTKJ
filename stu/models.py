...
class StudentInfo(models.Model):
    no = models.CharField(max_length=20, verbose_name="编号", null=False)
    ...
    age = models.PositiveIntegerField(default=20, verbose_name="年龄")
    ...
    is_delete = models.BooleanField(verbose_name="是否删除", default=False, null=True, blank=True)
